...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        uninformed(Integer.parseInt(args[1]), Integer.parseInt(args[2]), vertexNum);
    ...
    private static void uninformed(int sourceVertex, int targetVertex, int vertexNum) {
        ...
        UCS ucs = new UCS(graph, sourceVertex, targetVertex, vertexNum);
     ...
     */
    private static void informed(int sourceVertex, int targetVertex) {
    ...
    private static void showUsage() {
        String usage = "Usage:" + System.lineSeparator() +
                "java -jar ShortestPath.jar <input file>" + System.lineSeparator() +
                "Example:" + System.lineSeparator() +
                "java -jar ShortestPath.jar ~/Downloads/graph.txt";
